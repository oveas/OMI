...
lists\index{tag lists}\index{enter input!tagging from a list}.
...
\indent INPUT1 = Select a user{\#}{\{}SEL\textbar SYSTEM{\_}USERS{\}}USRNAME{\#}VALUE3 \newline
...
\begin{itemize}
\item Bugfix in finding modules if not located in the first index when \textsl{OMI{\$}MENU{\_}DIRECTORY} is a searchpath.
\end{itemize}
