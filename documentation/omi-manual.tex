...
\item Fix: Option \texttt{0} signalled \texttt{TOPLEVEL} messages at all levels
\item Fix: When \textsl{/JUMPS} ended in the main menu, \lt Ctrl/Z\gt{} didn't cause an exit the first time and an abort at the second attempt.
...
\item \textsl{/JUMPS} qualifer doesn't require \textsl{/SUBMENU} anymore but starts in the toplevel menu when omitted.
\end{itemize}
